...
setup_strongswan_restart_service() {
    ...
    if pidof systemd > /dev/null; then
        ...
        # Handle non-systemd systems 
        echo "Non-systemd system detected. Please configure the StrongSwan restart service manually."
    fi
}
...
remove_strongswan_restart_service() {
    ...
    if pidof systemd > /dev/null; then
        ...
        # Handle non-systemd systems 
        echo "Non-systemd system detected. Please remove the StrongSwan restart service manually."
    fi
}
